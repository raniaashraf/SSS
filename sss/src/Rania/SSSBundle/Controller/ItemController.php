...
namespace Rania\SSSBundle\Controller;

use Symfony\Component\HttpFoundation\Request;
use Symfony\Bundle\FrameworkBundle\Controller\Controller;

use Rania\SSSBundle\Entity\Item;
use Rania\SSSBundle\Form\ItemType;
...
class ItemController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('RaniaSSSBundle:Item')->findAll();

        return $this->render('RaniaSSSBundle:Item:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('RaniaSSSBundle:Item:new.html.twig', array(
            'entity' => $entity,
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('RaniaSSSBundle:Item')->find($id);
        ...
        return $this->render('RaniaSSSBundle:Item:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('RaniaSSSBundle:Item:edit.html.twig', array(
            'entity'      => $entity,
